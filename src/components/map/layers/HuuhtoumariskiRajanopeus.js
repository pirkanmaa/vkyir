...
const HuuhtoumaRajanopeus = new Tile({
  source: source,
  opacity: 0.75,
  title: "Huuhtouma (maalajin rajanopeus ylittyy)",
  name: "Huuhtouma (maalajin rajanopeus ylittyy)",
  visible: false,
...
export default HuuhtoumaRajanopeus;
