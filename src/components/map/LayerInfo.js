...
class LayerInfo extends Component {
    ...
    showLegend = layer => {
        ...
        switch (layer) {
            case 'Eroosiomalli':
                return <div classes={{ root: classes.root }}><br /><Divider />
            ...
            case 'Vesienhoidon tehostamisalueet':
                return <div classes={{ root: classes.root }}><br /><Divider />
                    ...
                    <img src="https://tieto.pirkanmaa.fi/geoserver/pirely/ows?service=WMS&request=GetLegendGraphic&format=image%2Fpng&width=24&height=24&layer=TPO&legend_options=fontName:Arial;fontSize:14;fontAntiAliasing:true"></img>
                </div>
                break;
                ...
                return <div classes={{ root: classes.root }}><br /><Divider />
                    ...
                    {legend1.map((types, i) =>
                        <div key={i} className={classes.slot}>
                            ...
                            <Typography variant="body1" style={{ color: 'black', fontSize: '14px', fontWeight: 400 }}>{types.type}</Typography>
                        </div>
                    )}
                </div>
                break;
